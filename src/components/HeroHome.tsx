        ...
        <div className="pt-20 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1
              ...
              data-aos="zoom-y-out"
            >
              Checkout, Shipping {"&"} Bidding for{" "}
              <span className="text-pink-500">Instagram Shops</span>
              {/* by spending less time managing your IG */}
            </h1>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                <div>
                  ...
                  <button
                    onClick={sendText}
                    className="btn text-white bg-purple-500 hover:bg-purple-600 w-full mb-4 sm:w-auto sm:mb-0"
                  >
                    Sign up
                  </button>
                </div>
